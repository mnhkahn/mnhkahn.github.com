...
figure: "http://blog.cyeam.com/assets/images/c168.png"
...
该图中，由`mint@121.199.55.106:5060`向`ad@10.14.5.202:10060`发起连接请求，内容格式是SDP描述格式，该格式内容会包含音视频传输参数和传输端口。详细内容参考[下一节](https://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_sdp)。
