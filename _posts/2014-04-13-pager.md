...
##1 开发准备与评估
+ ####1.1 [前期开发方案](http://blog.cyeam.com/postgraduate%20design/2014/02/04/postgraduate_design_evaluate/)
+ ####1.2 [系统开发准备](http://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_prepare/)

##2 协议分析与实现
+ ####2.1 系统采用的多媒体编码标准分析
    + 2.1.1 [语音编解码技术](http://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_audio/)
    + 2.1.2 [视频编解码技术](http://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_video/)
+ ####2.2 系统采用的网络通信协议分析
    + 2.2.1 [会话发起协议SIP](http://blog.cyeam.com/postgraduate%20design/2014/03/05/sip/)
    + 2.2.2 [会话描述协议SDP](https://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_sdp)
    + 2.2.3 [实时传输协议RTP](http://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_rtp/)
    + *2.2.4 [实时流媒体协议RTSP](http://blog.cyeam.com/postgraduate%20design/2014/04/17/pager_rtsp/)*
